...
The `DATABASE_URL` and `CONFIG_NAME='production'` environment variables are required to be set in the production environment. You can also set `SENTRY_DSN` for exception logging.
